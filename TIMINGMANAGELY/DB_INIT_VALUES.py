...
# Add testing shifttemplate #
# SQL = """INSERT INTO ShiftTemplate (day, starttime, endtime, preffered_employee)
#             VALUES (?,?,?,?)"""
# ShiftTemplateList = [[0, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [0, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [0, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [1, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [1, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [2, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [3, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0],
#                      [4, time(10,0,15).strftime('%H:%M:%S'), time(6,0,0).strftime('%H:%M:%S'), 0]]
# for shift in ShiftTemplateList:
#     cur.execute(SQL, (shift[0], shift[1], shift[2], shift[3]))
