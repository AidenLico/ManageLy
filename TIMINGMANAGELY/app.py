    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/shiftscheduling | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "add":
            ...
            if day and starttime and endtime and employee:
                ...
                add_endtime = time.time()
                add_executiontime = add_endtime - add_starttime
                print(f"SHIFT SCHEDULING ADD SHIFT TEMPLATE EXECUTION TIME {add_executiontime}")
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/shiftscheduling | Function: Add Shift Template | Execution Time: {add_executiontime} seconds\n')
            ...
            try:
                ...
                executiontime = endtime - starttime
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/shiftscheduling | Function: Delete Shift Template | Execution Time: {executiontime} seconds\n')
                return flask.redirect(flask.url_for("shiftscheduling"))
            except:
            ...
            executiontime = endtime - starttime
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/shiftscheduling | Function: Auto Schedule Shifts | Execution Time: {executiontime} seconds\n')
            return flask.redirect(flask.url_for("shiftscheduling"))
            ...
            if date and starttime and endtime and employee:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/shiftscheduling | Function: Manual Add Shift | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("shiftscheduling"))
            else:
            ...
            try:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/shiftscheduling | Function: Manual Delete Shift | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("shiftscheduling"))
            except:
                flask.flash("Shift Does Not Exist!")
                return flask.render_template("shiftscheduling.html", usertype=userType, shifts=shifts, employees=employees, businessname=businessName, actualshifts=actualShifts, leftbar=True, rightbar=True)
        ...
        if action == "accept":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/shiftscheduling | Function: Accept Shift | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.redirect(flask.url_for("shiftscheduling"))
        elif action == "decline":#
            STARTTIME = time.time()
            shiftID = flask.request.form.get("shiftID")
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/shiftscheduling | Function: Decline Shift | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.redirect(flask.url_for("shiftscheduling"))
        else:
...
def chat():
    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/chat | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "messageGroup":
            ...
            if message:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/chat | Function: Message Group | Execution Time: {EXECUTIONTIME} seconds\n')
            ...
            if message:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/chat | Function: Reply Group | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("chat"))
            else:
                flask.flash("Please Enter Message!")
                return flask.render_template("chat.html", usertype=userType, businessname=businessName, groupmessages=updatedMessages, groupreplies=updatedReplies, username=userName, employees=employees, directMessages=updatedDirectMessages, leftbar=True, rightbar=True)
            ...
            if employee and message:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/chat | Function: Direct Message | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("chat"))
            else:
                flask.flash("Please Enter Message!")
                return flask.render_template("chat.html", usertype=userType, businessname=businessName, groupmessages=updatedMessages, groupreplies=updatedReplies, username=userName, employees=employees, directMessages=updatedDirectMessages, leftbar=True, rightbar=True)
        ...
        if action == "messageGroup":
            ...
            if message:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/chat | Function: Direct Message Reply | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("chat"))
            else:
                flask.flash("Please Enter Message!")
                return flask.render_template("chat.html", usertype=userType, businessname=businessName, groupmessages=updatedMessages, groupreplies=updatedReplies, directmessages=updatedDirectMessages, username=userName, rightbar=True)
...
def holidaybooking():
    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/holidaybooking | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "approveRequest":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/holidaybooking | Function: Approve Holiday Request | Execution Time: {EXECUTIONTIME} seconds\n')
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/holidaybooking | Function: Deny Holiday Request | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.redirect(flask.url_for("holidaybooking"))
            ...
            if startDate and endDate and employee:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/holidaybooking | Function: Manually Add Holiday | Execution Time: {EXECUTIONTIME} seconds\n')
                return flask.redirect(flask.url_for("holidaybooking"))
            else:
                flask.flash("Please Fill All Fields!")
                return flask.render_template("holidaybooking.html", usertype=userType, businessname=businessName, employees=foundEmployees, holidayrequests=updatedHolidays, rightbar=True)
        ...
        if action == "submitRequest":
            ...
            if startDate and endDate and reason:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/holidaybooking | Function: Make Holiday Request | Execution Time: {EXECUTIONTIME} seconds\n')
...
def sales():
    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sales | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "previous":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sales | Function: View Previous Week Sales | Execution Time: {EXECUTIONTIME} seconds\n')
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sales | Function: View Next Week Sales | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.render_template("sales.html", usertype=userType, businessname=businessName, date=newDate, products=productTotals, employeesSales=employeeTotals, total=totalMade)
    else:
        return flask.redirect(flask.url_for("portal"))
...
def sheets():
    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sheets | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "download":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sheets | Function: Request Employee Timesheet | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "download":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/sheets | Function: Request Employee Paysheet | Execution Time: {EXECUTIONTIME} seconds\n')
...
def stock():
    ...
    if userType == "owner" or userType == "employee":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/stock | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "createStock":
            ...
            if name and amount and minAmount:
                ...
                if amount < 1 or minAmount < 1:
                    ...
                    if date:
                        ...
                        EXECUTIONTIME = ENDTIME - STARTTIME
                        with open('execution_log.txt', 'a') as log_file:
                            log_file.write(f'Route: /portal/stock | Function: Create Product Stocked | Execution Time: {EXECUTIONTIME} seconds\n')
            ...
            if value:
                ...
                if value < 1:
                    ...
                    EXECUTIONTIME = ENDTIME - STARTTIME
                    with open('execution_log.txt', 'a') as log_file:
                        log_file.write(f'Route: /portal/stock | Function: Increase Stock Amount | Execution Time: {EXECUTIONTIME} seconds\n')
                    return flask.redirect(flask.url_for("stock"))
            else:
                flask.flash("Increase Amount Should Be Greater Than 0!")
                return flask.render_template("stock.html", usertype=userType, businessname=businessName, stocks=foundStock, alerts=alerts, forecast=forecast, leftbar=True, rightbar=True)
            ...
            if value:
                ...
                if value < 1:
                    ...
                    EXECUTIONTIME = ENDTIME - STARTTIME
                    with open('execution_log.txt', 'a') as log_file:
                        log_file.write(f'Route: /portal/stock | Function: Decrease Stock Amount | Execution Time: {EXECUTIONTIME} seconds\n')
                    EXECUTE(SQL, values=(newAmount, stockID))
                    return flask.redirect(flask.url_for("stock"))
            else:
                flask.flash("Decrease Amount Should Be Greater Than 0!")
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/stock | Function: Delete Product Stocked | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.redirect(flask.url_for("stock"))
...
def calendar():
    ...
    if userType == "owner":
        ...
        if flask.request.method == "GET":
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/calendar | Render Time | Execution Time: {EXECUTIONTIME} seconds\n')
        ...
        if action == "addEvent":
            ...
            if eventName and startdate and enddate:
                ...
                EXECUTIONTIME = ENDTIME - STARTTIME
                with open('execution_log.txt', 'a') as log_file:
                    log_file.write(f'Route: /portal/calendar | Function: Add Calendar Event | Execution Time: {EXECUTIONTIME} seconds\n')
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/calendar | Function: Delete Calendar Event | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.redirect(flask.url_for("calendar"))
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/calendar | Function: Next Calendar Events | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.render_template("calendar.html", usertype=userType, businessname=businessName, date=date, events=foundEvents, rightbar=True)
            ...
            EXECUTIONTIME = ENDTIME - STARTTIME
            with open('execution_log.txt', 'a') as log_file:
                log_file.write(f'Route: /portal/calendar | Function: Previous Calendar Events | Execution Time: {EXECUTIONTIME} seconds\n')
            return flask.render_template("calendar.html", usertype=userType, businessname=businessName, date=date, events=foundEvents, rightbar=True)
        else:
            return flask.render_template("calendar.html", usertype=userType, businessname=businessName, date=date, events=foundEvents, rightbar=True)
